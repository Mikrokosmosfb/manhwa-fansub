...
const startStr = `<div className="relative rounded-xl overflow-hidden p-3 border border-gray-800 bg-gray-900 my-2 min-h-[100px] flex flex-col justify-end">`;
const endStr = `</p>
                          </div>
                        </div>`;
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    console.log("Patched AdminModal list preview successfully");
} else {
    console.log("Could not find start or end index for replacing list preview");
}
