...
export const WeeklyPopularSlider: React.FC = () => {
  ...
  return (
    <section className="w-full my-6 animate-fadeIn">
      ...
      <div className="bg-gray-950/95 border-x border-b border-purple-500/30 rounded-b-2xl p-3 sm:p-4 shadow-2xl overflow-hidden">
        <div
          ref={scrollRef}
          className="flex gap-3 sm:gap-4 overflow-x-auto no-scrollbar scroll-smooth snap-x py-1"
        >
          {popularSeries.map(s => {
