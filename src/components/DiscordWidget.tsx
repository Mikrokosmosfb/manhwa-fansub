...
export const DiscordWidget: React.FC = () => {
  return (
    <div className="relative overflow-visible rounded-2xl bg-gradient-to-br from-[#1e1b29] to-[#110f18] border-2 border-[#5865F2] p-5 text-center shadow-xl my-6">
      ...
      <div className="space-y-2">
        <h3 className="text-base sm:text-lg font-bold text-[#5865F2] uppercase tracking-wider">
          Topluluğumuza Katıl!
        </h3>
        ...
        <div className="pt-2">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752c4] text-white font-bold text-sm px-6 py-2.5 rounded-xl shadow-lg hover:shadow-[#5865F2]/40 hover:-translate-y-0.5 active:translate-y-0 transition-all w-full sm:w-auto"
          >
