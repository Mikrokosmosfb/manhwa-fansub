...
export const AZListView: React.FC = () => {
  const { seriesList, setView, bookmarks } = useApp();
          ...
          {sorted.map(s => (
            ...
            >
              <img
                src={s.coverImage}
                alt={s.title}
                className="w-16 aspect-[2/3] object-cover rounded-xl flex-shrink-0 border border-purple-500/20 group-hover:scale-105 transition duration-300 self-start"
              />
