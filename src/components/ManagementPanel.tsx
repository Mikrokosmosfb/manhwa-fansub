...
export const ManagementPanel: React.FC = () => {
  ...
  const [activeNav, setActiveNav] = useState<ManagementNavTab>('manage-series');
        ...
        <main className="flex-1 min-w-0 p-3 sm:p-6 lg:p-8 space-y-6">
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            {(activeNav === 'manage-series' ||
              ...
              <div className="bg-gray-900/80 border border-purple-500/20 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-xl">
                <AdminModal
