...
export const SeriesDetail: React.FC<SeriesDetailProps> = ({ seriesId }) => {
  ...
  return (
    <div className="min-h-screen pb-16">
      ...
      {/* Hero Banner Section */}
      <div className="relative w-full h-48 sm:h-80 md:h-96 overflow-hidden bg-gray-950">
        <div
      ...
      <div className="max-w-6xl mx-auto px-2.5 sm:px-4 -mt-24 sm:-mt-48 relative z-20">
        <div className="bg-gray-900/95 border border-purple-500/20 rounded-2xl sm:rounded-3xl p-4 sm:p-8 shadow-2xl backdrop-blur-md">
          <div className="flex flex-col md:flex-row gap-5 md:gap-8">
            ...
            <div className="flex flex-col items-center md:items-start flex-shrink-0">
              <div className="relative w-36 sm:w-52 md:w-60 shadow-2xl rounded-2xl overflow-hidden border-2 border-purple-500/30">
