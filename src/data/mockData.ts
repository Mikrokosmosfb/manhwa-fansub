...
export const INITIAL_SERIES: Series[] = [
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Manhwa',
    status: 'Devam Ediyor',
    rating: 9.7,
    ageRating: 'Genel',
    ...
    chapters: [
      {
        ...
        images: [
          'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=600&auto=format&fit=crop&q=70&fm=webp',
          'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=600&auto=format&fit=crop&q=70&fm=webp'
        ]
      },
      {
        id: 'c-plum-4',
        ...
        images: [
          'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&auto=format&fit=crop&q=70&fm=webp'
        ]
      },
      {
        id: 'c-plum-3',
        ...
        images: [
          'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=600&auto=format&fit=crop&q=70&fm=webp'
        ]
      },
      {
        id: 'c-plum-2',
        ...
        images: [
          'https://images.unsplash.com/photo-1563089145-599997674d42?w=600&auto=format&fit=crop&q=70&fm=webp'
        ]
      }
    ]
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1534447677768-be436bb09401?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Manhua',
    status: 'Devam Ediyor',
    rating: 9.9,
    ageRating: 'Genel',
  ...
  },
  {
    ...
    title: 'Night Song',
    slug: 'night-song',
    coverImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Manhwa',
    status: 'Devam Ediyor',
    rating: 9.6,
    ageRating: 'Genel',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Web Novel',
    status: 'Devam Ediyor',
    rating: 9.9,
    ageRating: 'Genel',
...
"Bana... Aptal diyebilirsiniz."`
  ...
  },
  {
    ...
    slug: 'shadow-slave',
    coverImage: 'https://images.unsplash.com/photo-1514565131-fce0801e5785?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1514565131-fce0801e5785?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Web Novel',
    status: 'Devam Ediyor',
    rating: 9.8,
    ageRating: 'Genel',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Manhwa',
    status: 'Devam Ediyor',
    rating: 9.8,
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Web Novel',
    status: 'Devam Ediyor',
    rating: 9.7,
...
Böylece, kalkanın sahibini ikna etme planım başladı. İyi adam gibi görünmek istemiyordum ama kalkanı almak için bu şarttı.`
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1563089145-599997674d42?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Manhwa',
    status: 'Devam Ediyor',
    rating: 9.6,
  ...
  },
  {
    ...
    slug: 'eleceed',
    coverImage: 'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1533738363-b7f9aef128ce?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Webtoon',
    status: 'Devam Ediyor',
    rating: 9.9,
    ageRating: 'Genel',
    ...
    chapters: [
      {
        ...
        isNew: false,
        images: [
          'https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600&auto=format&fit=crop&q=70&fm=webp',
          'https://images.unsplash.com/photo-1533738363-b7f9aef128ce?w=600&auto=format&fit=crop&q=70&fm=webp'
        ]
      },
      {
        id: 'c-eleceed-2',
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=360&auto=format&fit=crop&q=70&fm=webp',
    heroImage: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=900&auto=format&fit=crop&q=75&fm=webp',
    type: 'Web Novel',
    status: 'Tamamlandı',
    rating: 9.3,
    ageRating: '18+',
...
Karma... Sonunda beni bulmuştu.`
  ...
  },
  {
    ...
    chapters: [
      { id: 'c-ml-1', number: 1, title: 'Bölüm 1', publishedDate: '1 gün önce', images: ['https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&auto=format&fit=crop&q=70&fm=webp'] }
    ]
  },
  {
    id: 's-our-omega',
    ...
    chapters: [
      { id: 'c-ool-1', number: 1, title: 'Bölüm 1', publishedDate: '2 gün önce', images: ['https://images.unsplash.com/photo-1534447677768-be436bb09401?w=600&auto=format&fit=crop&q=70&fm=webp'] }
    ]
  },
  {
    ...
    chapters: [
      { id: 'c-sm-1', number: 1, title: 'Bölüm 1', publishedDate: '1 gün önce', images: ['https://images.unsplash.com/photo-1579783902614-a3fb3927b675?w=600&auto=format&fit=crop&q=70&fm=webp'] }
    ]
  },
  {
    id: 's-bye-bye',
    ...
    chapters: [
      { id: 'c-bb-1', number: 1, title: 'Bölüm 1', publishedDate: '3 gün önce', images: ['https://images.unsplash.com/photo-1578632767115-351597cf2477?w=600&auto=format&fit=crop&q=70&fm=webp'] }
    ]
  },
  {
    id: 's-turning-novel',
  ...
  },
  {
    ...
    chapters: [
      { id: 'c-sd-1', number: 1, title: 'Bölüm 1', publishedDate: '4 gün önce', images: ['https://images.unsplash.com/photo-1509198397868-475647b2a1e5?w=600&auto=format&fit=crop&q=70&fm=webp'] }
    ]
  }
];
